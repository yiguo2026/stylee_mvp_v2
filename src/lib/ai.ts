import { WardrobeItem, Outfit, OutfitItem, ClothingCategory, RecommendedItem, RecognitionResult, DetectedItem, FilterTag, OCCASION_TAGS, STYLE_TAGS, COLOR_TAGS, TEMP_TAGS } from '@/types';
  ...
  "items": [
    {
      ...
      "season": ["适合的季节，从 spring/summer/autumn/winter/all_season 中选择1-3个"],
      "occasion_tags": ["适合的场合，从 daily_commute/date/travel/business/sport/ceremony/beach/hiking/home/party 中选择1-3个"],
      "description": "对该单品的简要描述（如：白色棉质圆领T恤、深蓝色直筒牛仔裤）"
    }
  ]
}
