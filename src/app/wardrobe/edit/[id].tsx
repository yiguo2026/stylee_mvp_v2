...
const CATEGORIES: ClothingCategory[] = ['上装', '下装', '连衣裙', '外套', '鞋', '包', '配饰'];
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.inner}>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                  <View style={styles.pickerRow}>
                    {COLOR_OPTIONS.map(c => (
                      <TouchableOpacity
                        key={c}
                        style={[styles.pickerChip, color === c && styles.pickerChipActive]}
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                  <View style={styles.pickerRow}>
                    {MATERIAL_OPTIONS.map(m => (
                      <TouchableOpacity
                        key={m}
                        style={[styles.pickerChip, material === m && styles.pickerChipActive]}
                        onPress={() => { setMaterial(m); setShowMaterialPicker(false); }}
                      >
        ...
        >
          {deleting
            ...
            : <Text style={styles.deleteText}>删除此单品</Text>
          }
        </TouchableOpacity>
      </ScrollView>
