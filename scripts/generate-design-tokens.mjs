...
const sourcePath = resolve(projectRoot, 'design-tokens/stylee-v3.8.tokens.json');
...
const ds = {
  ...
  typography: {
    ...
    heading: typographyToken('heading'),
    content: typographyToken('content'),
    support: typographyToken('support'),
  },
  motion: {
    duration: {
  ...
  component: {
    ...
    choiceChip: {
      visualMinHeight: numberToken('Components', 'choiceChip.visualMinHeight'),
      minimumTouch: numberToken('Components', 'choiceChip.minimumTouch'),
      radius: numberToken('Components', 'choiceChip.radius'),
      horizontalPadding: numberToken('Components', 'choiceChip.paddingX'),
      verticalPadding: numberToken('Components', 'choiceChip.paddingY'),
      contentGap: numberToken('Components', 'choiceChip.contentGap'),
      groupGap: numberToken('Components', 'choiceChip.groupGap'),
    },
    pageHeader: {
      minimumHeight: numberToken('Components', 'pageHeader.minHeight'),
      horizontalPadding: numberToken('Components', 'pageHeader.paddingX'),
      actionSize: numberToken('Components', 'pageHeader.actionSize'),
    },
    searchField: {
      height: numberToken('Components', 'searchField.height'),
      radius: numberToken('Components', 'searchField.radius'),
      horizontalPadding: numberToken('Components', 'searchField.paddingX'),
      contentGap: numberToken('Components', 'searchField.contentGap'),
      iconSize: numberToken('Components', 'searchField.iconSize'),
    },
    wardrobeCard: {
      radius: numberToken('Components', 'wardrobeCard.radius'),
      mediaAspectRatio: numberToken('Components', 'wardrobeCard.mediaRatio'),
      infoMinimumHeight: numberToken('Components', 'wardrobeCard.infoMinHeight'),
      infoHorizontalPadding: numberToken('Components', 'wardrobeCard.infoPaddingX'),
      infoVerticalPadding: numberToken('Components', 'wardrobeCard.infoPaddingY'),
    },
    wardrobeGrid: {
      referenceViewportWidth: numberToken('Components', 'wardrobeGrid.referenceViewportWidth'),
      referenceViewportHeight: numberToken('Components', 'wardrobeGrid.referenceViewportHeight'),
      columnsMobile: numberToken('Components', 'wardrobeGrid.columnsMobile'),
      columnsTablet: numberToken('Components', 'wardrobeGrid.columnsTablet'),
      visibleRowsReference: numberToken('Components', 'wardrobeGrid.visibleRowsReference'),
      screenPadding: numberToken('Components', 'wardrobeGrid.screenPadding'),
      screenPaddingTablet: numberToken('Components', 'wardrobeGrid.screenPaddingTablet'),
      columnGap: numberToken('Components', 'wardrobeGrid.columnGap'),
      rowGap: numberToken('Components', 'wardrobeGrid.rowGap'),
      controlsGap: numberToken('Components', 'wardrobeGrid.controlsGap'),
    },
    outfitItemCard: {
